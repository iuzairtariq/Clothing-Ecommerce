...
const Subscribtion = () => {
    ...
    return (
        <div className='text-center pb-24'>
            ...
            <form onSubmit={onSubmitHandler} className='inline-flex gap-2'>
                <input type="email" placeholder='Enter your email' required className='border rounded-md p-1 pl-3 dark:bg-accent text-slate-600 dark:text-slate-400' />
